...
describe('Settings page', () => {
  ...
  it('Should look at the url and check if it\'s correct', () => {
    cy.url().should(url => expect(url.endsWith('/settings/681266ce536e072b01791cb6')).to.be.true);
  });


  // it('Should read the game code', () => {
  //   page.readCode().should(text => expect(text.includes('681266ce536e072b01791cb6')).to.be.true);
  // });
